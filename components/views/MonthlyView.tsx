            ...
            <div className="flex-1 flex flex-col w-full overflow-hidden">
                ...
                <div className="flex-1 grid grid-cols-7 grid-rows-6 gap-1 overflow-hidden">
                    {monthGridDays.map((day, index) => {
                        ...
                        return (
                            <div key={index} className={`flex flex-col rounded-lg bg-black/10 p-1.5 overflow-hidden transition-opacity duration-300 ${isCurrentMonth ? 'opacity-100' : 'opacity-40'}`}>
